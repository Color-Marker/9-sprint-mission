...
- [x]  가장 기본적인 SecurityFilterChain을 등록하고, 이때 등록되는 필터 목록을 확인하세요.
...
- [x]  다음과 같이 권한을 정의하세요.
- 관리자: ADMIN, 채널 매니저: CAHNNEL_MANAGER, 일반 사용자: USER
- [x]  데이터베이스 스키마를 변경하세요.
...
- DisableEncodeUrlFilter,
  WebAsyncManagerIntegrationFilter, SecurityContextHolderFilter, HeaderWriterFilter, CsrfFilter,
